...
**Поддерживаемые базовые протоколы**: Shadowsocks ( R / 2022 ), Trojan, VMess, VLESS ( XHTTP / Reality ), Hysteria ( v1 / v2 ), TUIC, WireGuard, Tailscale, OpenVPN, SSH, AnyTLS, Mieru, Snell ( v1-v5 ), Masque, TrustTunnel, Sudoku, Gost-relay, а также стандартные HTTP/Socks5 и др.
